...
tempfile.WriteLine("Order No,Item ex. VAT,Component,Special Instructions,Width,Height,Showroom,Fabric Company,Fabric Description,Fabric Special Instructions")
elseif InStr(title,"Leg") then
tempfile.WriteLine("Order No,Item ex. VAT,Component,Special Instructions,Height,Special,Leg Finish")
elseif InStr(title,"Topper") then
tempfile.WriteLine("Order No,Item ex. VAT,Component,Special Instructions,Width,Length,Special Width,Special Length")
else
tempfile.WriteLine("Order No,Item ex. VAT,Component,Special Instructions,Width,Length,Special Width 1, Special Length 1,Special Width 2, Special Length 2,Showroom")
end if
