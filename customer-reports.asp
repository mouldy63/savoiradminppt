...
<form action="customerlist.asp" method="post" name="form1" onSubmit="return FrontPage_Form1_Validator(this)">	
					  <div class="content brochure">
			    <div class="one-col head-col">
			<p>Customer Order reports</p><p>&nbsp;</p>
                </div>
...
sql="SELECT * from status where retired='n'"
