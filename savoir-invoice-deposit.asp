...
PDF.AddHTML "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""2""><font size=""8px""><tr><td width=""80%"" style=""border-right:none""><font size=""8"">Total</font></td><td align=""right"">" & ordercurrency & formatnumber(invoicetotal,2) & "</td></tr><tr><td> &nbsp;</td><td align=""right"">&nbsp;</td></tr><tr><td>&nbsp;</td><td align=""right""> </td></tr></table>"

Dim deposittable
deposittable="<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""2""><font size=""8px""><tr><td width=""80%"" style=border-right:none><font size=""8"">Deposit Required:</font></td><td align=""right"">" & ordercurrency & formatnumber(invoicetotal/2,2) & "</td></tr><tr><td>VAT: "

if vat=0 then
	deposittable=deposittable & "n/a export to " & invoicecountry & ", VAT number " & vatno & "</td><td align=""right"">n/a</td>"
	
	deposittotal=invoicetotal/2
	else
	deposittable=deposittable & rs("vatrate") & "%</td><td align=""right"">" & ordercurrency & formatNumber(vat/2,2) & "</td>"
	deposittotal=invoicetotal/2 + CDbl(rs("vatrate")/2)
end if
Dim deposittotal

deposittable=deposittable & "</tr><tr><td>Gross Total: </td><td align=""right"">" & ordercurrency & formatnumber(deposittotal,2) & "</td></tr></table>"
PDF.SetProperty csPropGraphWidthLine, 1
DrawBox 60,x+55, 485, 38
PDF.AddHTML deposittable 

 


if showroomnotes<>"" and showroomadd=30 then 
PDF.AddHTML "<br><table width=""100%"" border=""0"" cellspacing=""2"" cellpadding=""1""><tr><td width=""80"">Notes:</td><td>1 CHINA Export<br />2 This invoice is for the deposit only<br />3 Payment due to confirm order<br />4 Savoir Beds Ltd standard terms & conditions apply</td></tr></font></table>"
end if
if showroomnotes<>"" and showroomadd<>30 then
