...
<%Dim postcode, postcodefull, val, Con, rs, recordfound, id, rspostcode, submit, count
count=0
val=""
val=Request("val")
...
<%
Set rs = getMysqlUpdateRecordSet("Select * from locationpages WHERE locationid=" & val & "", con)
rs("desc")=Request("editor1")
rs.Update
rs.close
set rs=nothing

Else
Set rs = getMysqlQueryRecordSet("Select * from locationpages WHERE idlocation=" & val & "", con)
%>
<div id="alerts">
		<noscript>
			<p>
		...
		<form action="heditpages.asp" method="post" name="form1" onSubmit="return FrontPage_Form1_Validator(this)">	
...
<p>Amend letter here (note salutation is created automatically:</p>
            <p>
