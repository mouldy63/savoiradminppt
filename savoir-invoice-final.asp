...
prodtable=prodtable & "<font size=""8px""><tr><td width=""40%""><b>Bed Model</b></td><td><b>Size</b></td><td align=""center""><b>Quantity</b></td><td align=""right""><b>Unit Price/" & rs("ordercurrency") & "</b></td><td align=""right""><b>Price/" & rs("ordercurrency") & "</b></td></tr>"
	...
	if rs("legsrequired")="y" then
		...
		prodtable=prodtable & "<tr><td>" & rs("legstyle") & " Legs<br />" & rs("legfinish") & "</td><td>" & rs("legheight") & "</td><td align=""center"">" & legqty & "</td><td align=""right"">" & ordercurrency & formatnumber(legindividualprice,2) & "</td><td align=""right"">" & ordercurrency & formatnumber(legprice,2) & "</td></tr>"
...
finalbalancetotal=rs("balanceoutstanding")
...
Dim invoicecountry, vatno
invoicecountry=rs2("InvoiceCountry")
vatno=rs2("vatno")
...
PDF.AddHTMLPos 220, 189, "<font size=""12px""><b>FINAL BALANCE INVOICE</b></font>"
...
Dim finalbalancetable, finalbalancetotal, depositpaid
finalbalancetotal=CDbl(rs("balanceoutstanding"))
depositpaid=CDbl(rs("total"))-CDbl(rs("balanceoutstanding"))

PDF.AddHTMLPos 380, x+4, "&nbsp;"
PDF.AddHTML "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""2""><font size=""8px""><tr><td width=""80%"" style=""border-right:none""><font size=""8"">Total</font></td><td align=""right"">" & ordercurrency & formatnumber(invoicetotal,2) & "</td></tr><tr><td>Deposit Paid</td><td align=""right"">" & ordercurrency & formatnumber(depositpaid,2) & "</td></tr><tr><td>&nbsp;</td><td align=""right""> </td></tr></table>"



finalbalancetable="<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""2""><font size=""8px""><tr><td width=""80%"" style=border-right:none><font size=""8"">Final Balance Required:</font></td><td align=""right"">" & ordercurrency & formatnumber(finalbalancetotal,2) & "</td></tr><tr><td>VAT: n/a export to " & invoicecountry & ", VAT number " & vatno & "</td>"




finalbalancetable=finalbalancetable & "</tr><tr><td>Gross Total: </td><td align=""right"">" & ordercurrency & formatnumber(finalbalancetotal,2) & "</td></tr></table>"
PDF.SetProperty csPropGraphWidthLine, 1
DrawBox 60,x+55, 485, 38
PDF.AddHTML finalbalancetable 

 


if showroomnotes<>"" and showroomadd=30 then 
PDF.AddHTML "<br><table width=""100%"" border=""0"" cellspacing=""2"" cellpadding=""1""><tr><td width=""80"">Notes:</td><td>1 CHINA Export<br />2 This invoice is for the final balance only<br />3 Payment due to confirm order<br />4 Savoir Beds Ltd standard terms & conditions apply</td></tr></font></table>"
end if
if showroomnotes<>"" and  showroomadd<>30 then
