...
<%Dim title, strname, surname, address1, address2, address3, town, county, postcode, country, company, position, tel, fax, email, xsource, comments, channel, submit, msg, strmsg, item, ItemValue, found, Con, rs, rs1, recordfound, id, sql, i, monthfrom, monthto, ddmonth, ddyear, monthfrom1, monthto1, showroomname
msg=""
msg=Request("msg")
...
sql="SELECT * from contact C, address A where C.source_site='SB' AND c.code=a.code"
...
If ddmonth<>"n" then
	...
	sql = sql & " AND (C.idlocation=34 or C.idlocation=37)"
...
tempfile.WriteLine("Original Alpha Name,Owning Region,Title,Firstname,Surname,Company,Address1,Address2,Address3,Town,County,Postcode,Country,Tel,Email,Status,Visit date,Source,Channel,Visit Date,Last Order Date,Accept Email,Accept Post,First Contact date")
Do until rs.eof
...
rs1.close
set rs1=nothing
excelLine = """" & rs("alpha_name") & """,""" & showroomname & """,""" & rs("title") & """,""" & rs("first") &  """,""" & rs("surname") &  """,""" & rs("Company") &  """,""" & rs("street1") &  """,""" & rs("street2") &  """,""" & rs("street3") &  """,""" & rs("town") &  """,""" & rs("county") &  """,""" & rs("postcode") &  """,""" & rs("country") &  """,""" & rs("tel") &  """,""" & rs("email_address") &  """,""" & rs("status") &  """,""" & rs("visit_date") &  """,""" & rs("source") &  """,""" & rs("channel") &  """,""" & rs("visit_date") &  """,""" & orderdt &  """,""" & rs("acceptemail") &  """,""" & rs("acceptpost") &  """,""" & rs("first_contact_date") &  """"
