...
If rs2("tel")<>"" then showroomaddress=showroomaddress & "<br />Tel: " & rs2("tel")
...
if left(rs("mattresstype"),11)="Zipped Pair" and (rs("mattresswidth")<>"Special (as instructions)" AND rs("mattresswidth")<>"Special Width" and rs("mattresslength")<>"Special (as instructions)" AND rs("mattresslength")<>"Special Width" AND rs("mattresswidth")<>"n") then
...
if accessoriesonly="n" then 
		...
		'end TOTAL DETAILS
		'PAYMENTS
		DrawBox 20,754, 270, 70
		'end PAYMENTS
		'CUST SIG
		DrawBox 310,754, 270, 70
		'end CUST SIG
		
		
		
		PDF.AddHtmlPos 380, 10, "<img src=""images/logo.gif"" width=""255"" height=""66"">"
		
		
		
		PDF.SetFont "F15", 16, "#999"
		PDF.AddHtmlPos 230, 5, "<font size=""5""><b>Delivery Note</b></font>"
		PDF.SetFont "F15", 12, "#999"
		PDF.AddHtmlPos 230, 30, "<font size=""4"">Order No. " & rs("order_number") & "</font>"
		PDF.SetFont "F15", 10, "#999"
		
		If rs("bookeddeliverydate")<>"" then
		PDF.AddHtmlPos 20, 10, "Delivery Date: <b>" & FormatDateTime(rs("bookeddeliverydate"),vbShortDate) & "</b>"
		else
		PDF.AddHtmlPos 20, 10, "Delivery Date: "
		end if
		
		
		PDF.AddHtmlPos 20, 25, "Delivery Time:<b> " & deltime & "</b>"
		PDF.AddHtmlPos 20, 40, "Delivered by: <b>" & deliveredby & "</b>"
		
		PDF.SetFont "F15", 9, "#999"
		PDF.AddHTMLPos 20, 53, "Showroom: " & showroomaddress
		PDF.AddHTML "<br /><hr>"
		PDF.AddHTMLPos 25, 73, s
		...
		PDF.AddHTMLPos 25, 743, "<img src=""images/whitebg.png"" width=""170"" height=""16"">"
		PDF.AddHTMLPos 315, 743, "<img src=""images/whitebg.png"" width=""170"" height=""16"">"
		...
		PDF.AddTextPos 33, 757, "Customer's Signature"
		...
		PDF.SetProperty csPropAddTextWidth , 2
		PDF.AddTextWidth 30,710,260, "I have requested that this item should not be assembled or installed today.  I understand that if I request assembly in the future that this will incur an assembly charge."
		PDF.AddTextWidth 310,710,270, "No claim in respect of any loss or damage to goods in transit or any shortage on delivery will be accepted unless the Customer shall have notified the Company in writing of such loss, damage or shortage within three days of delivery."
		
		PDF.AddHTMLPos 30, 765, "<font family=""Tahoma""><font size=""8"">Print Name:</font></font>"
		PDF.AddHTMLPos 30, 785, "<font family=""Tahoma""><font size=""8"">Company:</font></font>"
		PDF.AddTextPos 30, 810, "......................................................................................................."
		If rs("bookeddeliverydate")<>"" then 
		PDF.AddTextPos 130, 818, FormatDateTime(rs("bookeddeliverydate"),vbShortDate)
		end if
		
		PDF.AddHTMLPos 320, 765, "<font family=""Tahoma""><font size=""8"">Print Name:</font></font>"
		PDF.AddHTMLPos 320, 785, "<font family=""Tahoma""><font size=""8"">Company:</font></font>"
		PDF.AddTextPos 320, 810, "......................................................................................................." 
		If rs("bookeddeliverydate")<>"" then 
		PDF.AddTextPos 420, 818, FormatDateTime(rs("bookeddeliverydate"),vbShortDate)
		end if
...
DrawBox 20,744, 270, 80

DrawBox 310,744, 270, 80
'PDF.AddTextPos 10, 10, " Page: " & P+1 & " of " & NPage + 1
PDF.AddHtmlPos 380, 10, "<img src=""images/logo.gif"" width=""255"" height=""66"">"
PDF.SetFont "F15", 16, "#999"
		PDF.AddHtmlPos 230, 5, "<font size=""5""><b>Delivery Note</b></font>"
...
PDF.AddHTMLPos 25, 735, "<img src=""images/whitebg.png"" width=""160"" height=""16"">"
PDF.AddHTMLPos 316, 735, "<img src=""images/whitebg.png"" width=""160"" height=""16"">"
PDF.AddHTMLPos 30, 738, "Customer's Signature"
PDF.AddHTMLPos 320, 738, "Customer's Signature"
...
PDF.AddHTMLPos 320, 600, "<table width=""600""><tr><td width=""290""></td><td><b>DELIVERY INSTRUCTIONS: </b> <br />" & Utf8ToUnicode(rs("specialinstructionsdelivery")) & "</td></tr></table>"
		...
		PDF.SetProperty csPropAddTextWidth , 2
		PDF.AddTextWidth 30,695,260, "I have requested that this item should not be assembled or installed today.  I understand that if I request assembly in the future that this will incur an assembly charge."
		PDF.AddTextWidth 310,695,270, "No claim in respect of any loss or damage to goods in transit or any shortage on delivery will be accepted unless the Customer shall have notified the Company in writing of such loss, damage or shortage within three days of delivery."
		
		PDF.AddHTMLPos 30, 755, "<font family=""Tahoma""><font size=""8"">Print Name:</font></font>"
		PDF.AddHTMLPos 30, 775, "<font family=""Tahoma""><font size=""8"">Company:</font></font>"
		PDF.AddTextPos 30, 800, "......................................................................................................."
		If rs("bookeddeliverydate")<>"" then 
		PDF.AddTextPos 130, 808, FormatDateTime(rs("bookeddeliverydate"),vbShortDate)
		end if
		
		PDF.AddHTMLPos 320, 755, "<font family=""Tahoma""><font size=""8"">Print Name:</font></font>"
		PDF.AddHTMLPos 320, 775, "<font family=""Tahoma""><font size=""8"">Company:</font></font>"
		PDF.AddTextPos 320, 800, "......................................................................................................." 
		If rs("bookeddeliverydate")<>"" then 
		PDF.AddTextPos 420, 808, FormatDateTime(rs("bookeddeliverydate"),vbShortDate)
		end if
