...
sql="SELECT * from contact C, address A, region AS r,communication AS d, location AS e where C.source_site='SB' AND c.code=a.code AND c.OWNING_REGION=r.id_region AND A.code=d.code AND  C.idlocation=e.idlocation "
...
tempfile.WriteLine("Original Alpha Name,Owning Showroom,Title,Firstname,Surname,Company,Address1,Address2,Address3,Town,County,Postcode,Country,Tel,Email,Channel,Visit Date,Last Order Date,Accept Email,Accept Post,status,contact date,")
Do until rs.eof
...
excelLine = """" & rs("alpha_name") & """,""" & rs("location") & """,""" & rs("title") & """,""" & rs("first") &  """,""" & rs("surname") &  """,""" & rs("Company") &  """,""" & rs("street1") &  """,""" & rs("street2") &  """,""" & rs("street3") &  """,""" & rs("town") &  """,""" & rs("county") &  """,""" & rs("postcode") &  """,""" & rs("country") &  """,""" & rs("tel") &  """,""" & rs("email_address") &  """,""" & rs("channel") &  """,""" & rs("visit_date") &  """,""" & orderdt &  """,""" & rs("acceptemail") &  """,""" & rs("acceptpost") & """,""" & rs("status") &  """,""" & time(0) & """"
