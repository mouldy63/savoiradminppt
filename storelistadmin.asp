...
<div class="one-col head-col">
	<br /><br />
		...
		<form action="amend-storedetailadmin.asp" method="post" name="form1" onSubmit="return FrontPage_Form1_Validator(this)">
...
{
 if (theForm.val.value == "all") 
   { 
      alert('Please select a showroom to amend') 
      theForm.val.focus();
      return false; 
      }
