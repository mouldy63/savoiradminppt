...
order=""
submit=""
sql="Select * from qc_history_latest WHERE componentid=3 and purchase_no=" & purchase_no & ""
...
if (rs("legstyle")="" or rs("legstyle")="--" or rs("legstyle")=null) then 
	...
	if (rs("legstyle")="Holly" or rs("legstyle")="Georgian" or rs("legstyle")="Georgian (Brass cap)" or rs("legstyle")="Georgian Upholstered" or rs("legstyle")="Penelope") then 
...
PDF.SetFont "F15", 12, "#999"
PDF.AddTextPos 100, 186, rs("basesavoirmodel")
PDF.SetFont "F15", 10, "#999"
PDF.AddHTMLPos 20, 196, "<b>Box Type:</b> "
PDF.SetFont "F15", 12, "#999"
PDF.AddTextPos 100, 206,  rs("basetype")
PDF.SetFont "F15", 10, "#999"
PDF.AddHTMLPos 20, 216, "<b>Box W/L Box 1:</b> " 
PDF.SetFont "F15", 12, "#999"
PDF.AddTextPos 100, 226, basewidth & " cm x " & baselength1 & " cm" 
PDF.SetFont "F15", 10, "#999"
If basewidth2<>"" then 
...
PDF.AddHTMLPos 20, 316, "<b>Ticking:</b> " & rs("basetickingoptions")
 ...
 PDF.AddHTMLPos 20, 371, "<b>Start Date:</b>  ___________________"
 PDF.AddHTMLPos 20, 386, "<b>Start Time:</b>  ___________________"
 PDF.AddHTMLPos 20, 401, "<b>Spring to Roll:</b> ______________"
 PDF.AddHTMLPos 20, 416, "<b>To cover:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ______________"
 PDF.AddHTMLPos 175, 401, "<b>Your Time:</b> _________"
 PDF.AddHTMLPos 175, 416, "<b>Your Time:</b> _________"

 PDF.AddHTMLPos 20, 446, "<b>Wrapping Instructions:</b> " & wrappingtype

Set rs3 = getMysqlUpdateRecordSet("Select * from FireLabel where firelabelid=" & rs("firelabelid") , con)
If not rs3.eof then
PDF.AddHTMLPos 20, 466, "<b>Fire Label: </b>" & rs3("firelabel")
else
PDF.AddHTMLPos 20, 466, "<b>Fire Label: </b> N/a" 
end if
rs3.close
set rs3=nothing
PDF.AddHTMLPos 20, 486, "<b>Frame Made by: </b>......................." 
PDF.AddHTMLPos 20, 506, "<b>To be finished by: </b>......................." 

PDF.AddHTMLPos 310, 185, "<b>Box Special Instructions: </b>" 
x=175
...
if rs("basetrim")<>"" and not isNull(rs("basetrim")) then
	x=x+20
	PDF.AddHTMLPos 310, x+20, "Base Trim: " & rs("basetrim")
	PDF.AddHTMLPos 310, x+40, "Base Trim Colour: " & rs("basetrimcolour")
end if
