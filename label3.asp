...
PDF.AddHTMLPos 534, 325, "<font family=""Tahoma""><font size=""8"">" & getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("baseprice") & "</font></font>"
...
If rs("valancerequired")="y" then valreq="Yes" else valreq="No"
...
upholsterysum=Cdbl(rs("valanceprice"))+Cdbl(rs("valfabricprice"))

PDF.AddHTMLPos 534, 442, "<font family=""Tahoma""><font size=""8"">" & getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("valanceprice") & "</font></font>"
...
PDF.AddHTMLPos 534, 482, "<font family=""Tahoma""><font size=""8"">" & getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("valfabricprice") & "</font></font>"
...
upholsterysum=Cdbl(upholsterysum)+Cdbl(rs("hbfabricprice"))
...
PDF.AddTextPos 33, 621, "Mattress"

PDF.AddTextPos 193, 621, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("mattressprice")

PDF.AddTextPos 33, 633, "Base"

PDF.AddTextPos 193, 633, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("baseprice")

PDF.AddTextPos 33, 646, "Topper"

PDF.AddTextPos 193, 646, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("topperprice")

PDF.AddTextPos 33, 659, "Upholstery"

PDF.AddTextPos 193, 659, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & upholsterysum

PDF.AddTextPos 33, 672, "Headboard"

PDF.AddTextPos 193, 672, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("headboardprice")

PDF.AddHTMLPos 33, 677, "<b>Bed Set Total</b>"

PDF.AddHTMLPos 193, 677, getCurrencySymbolForCurrency(rs("ordercurrency")) & "<b>" & rs("bedsettotal") & "</b>"

If rs("discount")<>0 or rs("discount")<>"" then

PDF.AddTextPos 33, 702, "Discount"

PDF.AddTextPos 193, 702, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("discount")

end if

PDF.AddHTMLPos 33, 707, "<b>Sub Total</b>"

PDF.AddHTMLPos 193, 707, getCurrencySymbolForCurrency(rs("ordercurrency")) & "<b>" & rs("subtotal") & "</b>"

PDF.AddTextPos 33, 729, "Delivery Charge"

PDF.AddTextPos 193, 729, getCurrencySymbolForCurrency(rs("ordercurrency")) & " " & rs("deliveryprice")

PDF.AddHTMLPos 33, 732, "<b>TOTAL</b>"

PDF.AddHTMLPos 193, 732, getCurrencySymbolForCurrency(rs("ordercurrency")) & "<b>" & rs("total") & "</b>"
...
paymentSum = 0.0
	 ...
	 str7=str7 & "<tr><td></td><td><b>Type</b></td><td><b>Method</b></td><td><b>Receipt No.</b></td><td align=""right""><b>Amount</b></td></tr>"   
	     ...
	     for n = 1 to ubound(payments)
		    ...
		    str7=str7 & "<tr><td width=10></td><td width=80><font family=""Tahoma""><font size=""8"">"
	...
	str7=str7 & "<tr><td></td><td colspan=""3""><b>Outstanding Balance</b></td><td align=""right"">" & getCurrencySymbolForCurrency(rs("ordercurrency")) & "<b>" & rs("balanceoutstanding") & "</b></td></tr></table>"
