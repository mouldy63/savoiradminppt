						...
						$.confirm({
							...
							buttons: {
								confirm: {
									...
									btnClass: 'btn-orange',
									action: function () {
										$("#nextpage").val(value + "&ordersource=Customer");
										$("#form1").submit();
									}
								},
								confirm2: {
								...
								someButton: {
                                    ...
                                    btnClass: 'btn-green',
                                    action: function () {
                                        this.$content.find('span').append('<br><b>Customer Order:</b><br>Select this option if you want to place an order for your customer.<br><br><b>Floorstock Order:</b><br>Select this option if you are placing an order which is a floorstock bed for your showroom display.<br><br><b>Stock Order:</b><br>Select this option if you are placing an order for delivery or storage to your warehouse.<br><br>');
