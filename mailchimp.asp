...
sql="select * from contact C, Address A where C.code=A.code and is_developer='n' AND C.contact_no<>319256 AND C.contact_no<>24188 and C.contact_no > 362720 and C.contact_no < 365758"
'response.End()
...
tempfile.WriteLine("Customer No,Date Added,Customer Status,Customer Type,Title,First Name,Surname,Add1,Add2,Add3,Town,Postcode,Country,Company,Email,Tel,Tel Work,Mobile,Showroom,Bed Purchase,Products Purchased,Order No.,Booked Delivery Date,Accessories,Purchase Date,Order Value ex VAT,Currency,Date Updated,Updated By,Acceptemail,Notes")
Do until rs.eof
notes=""
	sql3="select notes, date from Communication where code=" & rs("code") & ""
	Set rs4 = getMysqlQueryRecordSet(sql3, con)
	do until rs4.eof
	notes=notes & rs4("date") & " " & rs4("notes") & " : "
	rs4.movenext
	loop
	rs4.close
	set rs4=nothing
...
sql2="select * from purchase P, location L where P.contact_no=" & rs("contact_no") & " and P.idlocation=L.idlocation and orderSource<>'Test' and orderSource<>'Marketing' and (cancelled is Null or cancelled='n') and quote='n'"
...
if not rs1.eof then
	...
	excelLine = """" & contactno & """,""" & rs("dateadded") & """,""" & rs("status") & """,""" & customertype & """,""" & rs("title") & """,""" & rs("first") & """,""" & rs("surname") & """,""" & rs("street1") & """,""" & rs("street2") & """,""" & rs("street3") & """,""" & rs("town") & """,""" & rs("postcode") & """,""" & rs("country") & """,""" & rs("company") & """,""" & rs("email_address") & """,""" & rs("tel") & """,""" & rs("telwork") & """,""" & rs("mobile") & """,""" & showroomname & """,""" & bedname & """,""" & orderedprod & """,""" & orderNo & """,""" & bookeddeliverydate & """,""" & accsummary & """,""" & left(rs1("order_date"),10) & """,""" & rs1("totalexvat") & """,""" & rs1("ordercurrency") & """,""" & rs("dateupdated") & """,""" & rs("Updatedby") & """,""" & rs("acceptemail") & """,""" & notes & """"
...
showroomname=""
bedname=""
excelLine = """" & contactno & """,""" & rs("dateadded") & """,""" & rs("status") & """,""" & customertype & """,""" & rs("title") & """,""" & rs("first") & """,""" & rs("surname") & """,""" & rs("street1") & """,""" & rs("street2") & """,""" & rs("street3") & """,""" & rs("town") & """,""" & rs("postcode") & """,""" & rs("country") & """,""" & rs("company") & """,""" & rs("email_address") & """,""" & rs("tel") & """,""" & rs("telwork") & """,""" & rs("mobile") & """,""" & showroomname & """,""" & bedname & """,""" & bedname & """,""" & orderNo & """,""" & bookeddeliverydate & """,""" & showroomname & """,""" & showroomname & """,""" & showroomname & """,""" & showroomname & """,""" & rs("dateupdated") & """,""" & rs("updatedby")& """,""" & rs("acceptemail") & """,""" & notes & """"
tempfile.WriteLine(excelLine)
