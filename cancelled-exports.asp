...
if ordersql="" or ordersql="a" then ordersql="asc"
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr valign="top">
    <td width="647" class="maintext">
      ...
      <h1>Cancelled Shipments</h1>
      <table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <td>Showrooms</td>
          <td>Collection Date<a href="cancelled-exports.asp?ordersql=d"><br>
        <img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="cancelled-exports.asp?ordersql=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle" border="0"></a></td>
          <td>ETA Date</td>
          <td>Shipper</td>
        ...
        <%if rs.eof then response.Write("<tr><td colspan=""9"">Currently there are no cancelled shipments</td></tr>")
		do until rs.eof%>
