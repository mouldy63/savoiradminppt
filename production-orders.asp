...
sql = sql & ", Location L"
sql = sql & " Where (P.cancelled is null or P.cancelled <> 'y') AND C.retire='n' AND A.code=C.code AND C.contact_no=P.contact_no AND P.completedorders='n' AND P.orderConfirmationStatus='y' AND P.quote='n' "
...
<table border="0" cellpadding="6" cellspacing="2">
 <tr>
    <td width="88"><b>Customer Name<a href="production-orders.asp?customerasc=d"><br>
      <img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?customerasc=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle"border></a></b></td>
       <td width="69"><strong>Company<br>
       </strong><b><a href="production-orders.asp?companyasc=d"><img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?companyasc=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle"border></a></b></td> 
       <td width="75"><b>Order No<a href="production-orders.asp?orderasc=d"><br>
        <img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?orderasc=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle" border="0"></a></b></td>
...
<td width="59"><strong>Showroom<br>
       <a href="production-orders.asp?showr=d"><br>
        <img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?showr=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle" border="0"></a></strong></td>
<%end if%>
    ...
    <td width="124"><strong>Production Date<br><a href="production-orders.asp?productiondate=d"><img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?productiondate=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle"border></a>
    <td width="124"><strong>Booked Delivery Date<br><a href="production-orders.asp?bookeddate=d"><img src="img/desc.gif" alt="Descending" width="34" height="30" align="middle" border="0"></a><a href="production-orders.asp?bookeddate=a"><img src="img/asc.gif" alt="Ascending" width="34" height="30" align="middle"border></a>
    </strong></td>
    <td width="21">&nbsp;</td>
    </tr>
<%Do until rs.EOF%>
