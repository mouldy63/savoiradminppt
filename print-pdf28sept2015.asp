...
Dim matt1width, matt2width, matt1length, matt2length, base1width, base2width, base1length, base2length, topper1width, topper1length, basewidthstring, mattwidthstring, topperwidthstring, speciallegheight, savoirterms
...
If rs("baserequired")="y" or rs("legsrequired")="y" then
		...
		DrawBox 20,x-5, 560, 136
		else
		DrawBox 20,x-5, 560, 86
		end if
		PDF.SetProperty csPropGraphLineColor, "silver"
		DrawBox 25,x+50, 500, 25
		if (rs("upholsteredbase") <> "n" and  Not isNull("upholsteredbase")) then
			DrawBox 25,x+102, 500, 25
		end if
		PDF.SetProperty csPropGraphLineColor, "black"
		
		PDF.AddHTMLPos 25, x-10, "<img src=""images/whitebg.png"" width=""90"" height=""16"">"
		
		PDF.AddHTMLPos 33, x-12, "<font family=""Tahoma""><font size=""8""><b>Base</b></font></font>"
		PDF.AddHTMLPos 33, x, "<font family=""Tahoma""><font size=""8"">Model:</font></font>"
		...
		If rs("legprice")<>"" and NOT ISNULL(rs("legprice")) then
			If CDbl(rs("legprice"))>0.0 then
				baseprice=CDbl(rs("legprice"))
			end if
		end if
	...
	PDF.AddHTMLPos 534, x+10, "<font family=""Tahoma""><font size=""8""><b>" & getCurrencySymbolForCurrency(rs("ordercurrency")) & FormatNumber(baseprice,2) & "</b></font></font>"
		...
		PDF.AddHTMLPos 33, x+12, "<font family=""Tahoma""><font size=""8"">Leg Style/Finish:</font></font>"
		PDF.AddHTMLPos 95, x+12, "<font family=""Tahoma""><font size=""8""><b>" & rs("legstyle") & "</b></font></font>"
		PDF.AddHTMLPos 225, x+12, "<font family=""Tahoma""><font size=""8"">Leg Finish:</font></font>"
		PDF.AddHTMLPos 272, x+12, "<font family=""Tahoma""><font size=""8""><b>" & rs("legfinish") & "</b></font></font>"
		PDF.AddHTMLPos 410, x+12, "<font family=""Tahoma""><font size=""8"">Leg Height:</font></font>"
		If speciallegheight<>"" then
		PDF.AddHTMLPos 457, x+12, "<font family=""Tahoma""><font size=""8""><b>" & speciallegheight & "cm</b></font></font>"
		else
		PDF.AddHTMLPos 457, x+12, "<font family=""Tahoma""><font size=""8""><b>" & rs("legheight") & "</b></font></font>"
		end if
		PDF.AddHTMLPos 33, x+24, "<font family=""Tahoma""><font size=""8"">Link Position:</font></font>"
		PDF.AddHTMLPos 88, x+24, "<font family=""Tahoma""><font size=""8""><b>" & rs("linkposition") & "</b></font></font>"
		PDF.AddHTMLPos 225, x+24, "<font family=""Tahoma""><font size=""8"">Link Finish:</font></font>"
		PDF.AddHTMLPos 272, x+24, "<font family=""Tahoma""><font size=""8""><b>" & rs("linkfinish") & "</b></font></font>"
	...
	'If rs("basedrawerconfigID")<>"n" then	
		PDF.AddHTMLPos 33, x+36, "<font family=""Tahoma""><font size=""8"">Drawers:</font></font>"
		PDF.AddHTMLPos 88, x+36, "<font family=""Tahoma""><font size=""8""><b>" & rs("basedrawerconfigID") & "</b></font></font>"
		PDF.AddHTMLPos 225, x+36, "<font family=""Tahoma""><font size=""8"">Drawer Height:</font></font>"
		PDF.AddHTMLPos 280, x+36, "<font family=""Tahoma""><font size=""8""><b>" & rs("basedrawerheight") & "</b></font></font>"
		PDF.AddHTMLPos 410, x+36, "<font family=""Tahoma""><font size=""8""></font></font>"
		PDF.AddHTMLPos 447, x+36, "<font family=""Tahoma""><font size=""8""><b></b></font></font>"
		'end if
	
	if (rs("upholsteredbase") <> "n" and  Not isNull("upholsteredbase")) then
		PDF.AddHTMLPos 410, x+36, "<font family=""Tahoma""><font size=""8"">Upholstered Base:</font></font>"
		PDF.AddHTMLPos 477, x+36, "<font family=""Tahoma""><font size=""8""><b>" & rs("upholsteredbase") & "</b></font></font>"
		else
		PDF.AddHTMLPos 410, x+36, "<font family=""Tahoma""><font size=""8"">Upholstered Base: No</font></font>"
	end if
			...
			PDF.SetFont " F1 ", 6, " #000000"
			PDF.SetProperty csPropAddTextWidth , 2
			PDF.AddTextWidth 33,x+58,490, str2
			end if
	if (rs("upholsteredbase") <> "n" and  Not isNull("upholsteredbase")) then
		If rs("basefabric")<>"" then
		PDF.AddHTMLPos 33, x+75, "<font family=""Tahoma""><font size=""8"">Fabric Selection:</font></font>"
		PDF.AddHTMLPos 98, x+75, "<font family=""Tahoma""><font size=""8""><b>" & rs("basefabric") & "</b></font></font>"
		PDF.AddHTMLPos 410, x+75, "<font family=""Tahoma""><font size=""8"">Direction:</font></font>"
		PDF.AddHTMLPos 450, x+75, "<font family=""Tahoma""><font size=""8""><b>" & rs("basefabricdirection") & "</b></font></font>"
		PDF.AddHTMLPos 33, x+87, "<font family=""Tahoma""><font size=""8"">Description:</font></font>"
		PDF.AddHTMLPos 98, x+87, "<font family=""Tahoma""><font size=""8""><b>" & rs("basefabricchoice") & "</b></font></font>"
		PDF.AddHTMLPos 534, x+75, "<font family=""Tahoma""><font size=""8"">PRICE:</font></font>"
		PDF.AddHTMLPos 534, x+85, "<font family=""Tahoma""><font size=""8""><b>" & getCurrencySymbolForCurrency(rs("ordercurrency")) & FormatNumber(baseupholsteryprice,2) & "</b></font></font>"
		end if
		If rs("basefabricdesc")<>"" then
				str18="Base Fabric Instructions: " & rs("basefabricdesc") & " "
				PDF.SetFont " F1 ", 6, " #000000"
				PDF.SetProperty csPropAddTextWidth , 2
				PDF.AddTextWidth 33,x+110,490, str18
		end if
	end if
...
DrawBox 20,x-5, 560, 103
PDF.SetProperty csPropGraphLineColor, "silver"
DrawBox 25,x+27, 500, 25
DrawBox 25,x+69, 500, 25
PDF.SetProperty csPropGraphLineColor, "black"
PDF.AddHTMLPos 25, x-10, "<img src=""images/whitebg.png"" width=""90"" height=""16"">"
PDF.AddHTMLPos 33, x-12, "<font family=""Tahoma""><font size=""8""><b>Headboard</b></font></font>"
	...
	PDF.AddHTMLPos 534, x+41, "<font family=""Tahoma""><font size=""8""><b>" & getCurrencySymbolForCurrency(rs("ordercurrency")) & "0.00</b></font></font>"
	end if
	...
	PDF.AddHTMLPos 428, x+53, "<font family=""Tahoma""><font size=""8"">Direction:</font></font>"
	PDF.AddHTMLPos 466, x+53, "<font family=""Tahoma""><font size=""8""><b>" & rs("headboardfabricdirection") & "</b></font></font>"
