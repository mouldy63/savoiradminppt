...
%>
    ...
    <tr>
	  ...
	  if left(rs("mattresstype"),3)="Zip" then componentNoTobefinished=componentNoTobefinished+2 else componentNoTobefinished=componentNoTobefinished+1
	%>
      ...
      <%if rs("basesavoirmodel")<>"n" and rs("basesavoirmodel")<>"" and NOT ISNULL(rs("basesavoirmodel")) and compmadeat3=madeat and finishedcomp3="n"   then
	    if (left(rs("basetype"),3)="Nor" or left(rs("basetype"),3)="Eas") then componentNoTobefinished=componentNoTobefinished+2 else componentNoTobefinished=componentNoTobefinished+1%>
     ...
     <span style="white-space: pre;color:<%=getColourForEntry(con, rs("purchase_no"), "Cut", 3)%>">&#9608;</span>
	  ...
	  componentNoTobefinished=componentNoTobefinished+1%>
...
response.Write("<tr><td height=""17"" colspan=""9"" bgcolor=""#999999"">Week No. " & pweekno & "&nbsp;" & componentNoTobefinished & "</td><td height=""17""  bgcolor=""#999999"">Production&nbsp;Date </td></tr>")
componentNoTobefinished=0
else
