...
sql="SELECT * FROM contact C, Address A, Location L WHERE C.code=A.code and C.idlocation = L.idlocation and C.is_developer='n' AND C.contact_no<>319256 AND C.contact_no<>24188 and C.contact_no >332397 and C.CONTACT_NO<353196 and C.Source_site like 'SH'                                                                                                                                               "
'response.End()
...
sql2="select * from purchase P, location L where P.contact_no=" & rs("contact_no") & " and P.idlocation=L.idlocation and (cancelled is Null or cancelled='n') and quote='n'"
