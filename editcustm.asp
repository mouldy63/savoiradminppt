...
dim listPriceVal, tmpListPriceVal, tradeDiscountRate, myMail, telwork, mobile, orderTotals, orderTotalsForYear, totalsString, totalsForYearString, vals, deladdress, sql, z, preferredshipper, selectedA, slected, complete, nextpage
dim userLocTestStr
...
Dim nextarray(), custcode, differentfollowup, currentactivedate, customertype, showmarketing
showmarketing=""
customertype=""
...
<div class="row">
  ...
  If rs("acceptemail")="n" Then%>
    	<input name="acceptemail" type="checkbox" id="acceptemail" value="y" <%=showmarketing%>>
			<%else%>
         	<input name="acceptemail" type="checkbox" id="acceptemail" value="y" checked <%=showmarketing%>>
			<%End If%>
...
%>  
  ...
  <tr>
    ...
    <%if (isSuperuser or retrieveUserID()=273) then%>
