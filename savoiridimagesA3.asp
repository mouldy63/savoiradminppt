  ...
  <tr> 
    <td valign="top">
      ...
      <div align="left">
        ...
        <h1>Upload Article 3 image to Savoirid.com</h1>
        <hr>
        
        <p>The intro image currently is<br>
        <img src="http://www.savoirid.com/savoiridimages/interiordesigner-beds3A.jpg">
        </p>
        <form METHOD="POST" ENCTYPE="multipart/form-data" ACTION="douploadimage1.asp">
          <div align="left"><input name="fmused" type="hidden" value="article3">
 
            <p><strong>
                          </strong><strong>Add Intro Image (width 195px x height 117px)<br>
                          </strong>
                          <input name="FILE30" type="file" id="FILE30" size="30">
            </p>
			
            <p>Img Alt text<br>
            <%sql="Select * from texts where textkey like 'Article3text'"
			  Set rs = getMysqlUpdateRecordSet(sql, con)%>
              <textarea name="A3alttext" cols="60" id="A3alttext" ><%=rs("imgalttext")%></textarea>
              
            </p>
           <hr>
           <h1>Upload Article 3 Pop Up Header image to Savoirid.com</h1>
           <p>The main article pop up header image currently is<br>
             <img src="http://www.savoirid.com/savoiridimages/interiordesigner-beds3B.jpg"> </p>
           <p><strong>Add main article pop up header image  (width 702px - recommended height 273px)<br>
           </strong>
             <input name="FILE31" type="file" id="FILE31" size="30">
           </p>
           
            <p><strong>Enter alt text for image</strong><br>
            <%
			  Set rs = getMysqlUpdateRecordSet(sql, con)%>
              <textarea name="A3alttext2" cols="60" id="A3alttext2" ><%=rs("imgalttext3")%></textarea>
            ...
            <p>To add this image into the text copy and paste the following code and click on &quot;Source&quot; button <br>
              ...
              <font color="#FF0000"> &lt;span id=&quot;ctr&quot;&gt;&lt;img src=&quot;savoiridimages/interiordesigner-beds3C.jpg&quot; alt=&quot;&quot; /&gt;&lt;/span&gt;</font></p>
            <p><input name="FILE32" type="file" id="FILE32" size="30"></p>
            <h1>Upload extra Image 2 </h1>
            <p>To add this image into the text copy and paste the following code and click on &quot;Source&quot; button <br>
              PLEASE ADD ALT TEXT (description of images)              <br>
              <font color="#FF0000"> &lt;span id=&quot;ctr&quot;&gt;&lt;img src=&quot;savoiridimages/interiordesigner-beds3D.jpg&quot;  alt=&quot;&quot; /&gt;&lt;/span&gt;</font></p>
            <p><input name="FILE33" type="file" id="FILE33" size="30">
            </p>
            <p>&nbsp;</p>
           <hr>
              <%rs.close
