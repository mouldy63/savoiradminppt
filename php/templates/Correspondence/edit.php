...
<form action="/php/correspondence/edit" method="post" name="form1" >	
<input name="correspondenceid" type="hidden" value="<?php echo $row['correspondenceid']; ?>">
...
<p>  
  <label>
    <br>
    <input name="correspondencename" type="text" id="correspondencename" value="<?php echo $row['correspondencename']; ?>" size="40" maxlength="55" />
  </label></p>
...
<p><strong>If you would like to add Dear Mr xxxxx then </strong> enter greeting i.e. Dear<br>
  <br>
<label>
  <input name="greeting" type="text" id="greeting" value="<?php echo $row['greeting']; ?>" size="20">
  </label> 
...
<p>Available languages (<span id="count"> </span> languages!):<br />
		...
		<p>
			<textarea cols="80" id="editor1" name="editor1" rows="10"><?php echo $row['correspondence']; ?></textarea>
<input name="correspondence" type="hidden" value="<?php echo $row['correspondence']; ?>">
			<script type="text/javascript">
			//<![CDATA[
	      ...
	      <br>
	      <br>
          <textarea cols="80" id="editor2" name="editor2" rows="10"><?php echo $row['correspondence2']; ?></textarea>
