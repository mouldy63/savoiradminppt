...
var tableAdjustment = {
	...
	filterArray: function(parameter){
		...
		jQuery.ajax({
        	type: "POST",
        	url: "/php/fabricstatus/index",
        	data: JSON.stringify({filter:parameter,orderby:'',order:''}),
        	dataType: "json",
        	success: function (data) {
        		thisObj.refreshTable(data);
        	},
        	error: function(e){
	...
	reOderArray:function(parameter,order){
		...
		jQuery.ajax({
        	type: "POST",
        	url: "/php/fabricstatus/index",
        	data: JSON.stringify({filter:filter,orderby:parameter,order:order}),
        	dataType: "json",
        	success: function (data) {
        		thisObj.refreshTable(data);
        	},
...
<thead style="">
	...
	<tr>
		<th class="tablecell leftcell">
			<a href="#" onclick="tableAdjustment.reOderArray('1','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('1','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell">
			<a href="#" onclick="tableAdjustment.reOderArray('2','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('2','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell">
			<a href="#" onclick="tableAdjustment.reOderArray('3','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('3','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell">
			<a href="#" onclick="tableAdjustment.reOderArray('4','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('4','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell">
			<a href="#" onclick="tableAdjustment.reOderArray('5','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('5','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell leftcell">
		...
		<th class="tablecell">
			<a href="#" onclick="tableAdjustment.reOderArray('6','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('6','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
		<th class="tablecell rightcell">
			<a href="#" onclick="tableAdjustment.reOderArray('7','1'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/asc.gif" alt="Ascending" width="24" height="21" align="middle" border="">
			</a>
			<a href="#" onclick="tableAdjustment.reOderArray('7','2'); return false;" style="width:24px;float:left;">
			<img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/desc.gif" alt="Descending" width="24" height="21" align="middle" border="0">
			</a>
		</th>
	</tr>
