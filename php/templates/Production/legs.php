...
<div id="legs_div">
    ...
    <div class="form-row">
            ...
            <textarea name = "legsinstructions" id="legsinstructions" class="legsfield"  style="width:90%" rows = "1" maxlength="130"><?= $purchase['specialinstructionslegs'] ?></textarea><span class="pull-right label label-default" id="legcount"></span>
            </div>
        </div> 
