...
<div class="form-row">
    ...
    <textarea name = "baseinstructions" id="baseinstructions" class="basefield"  style="width:90%" rows = "1" maxlength="250"><?= $purchase['baseinstructions'] ?></textarea><span class="pull-right label label-default" id="basecount"></span>
    </div>
</div>  
<div class="form-row">
    <div class="form-group col-sm-2">
    ...
    <label for="basefabric" class="uphhide">Fabric Company:</label><br>
        <input name = "basefabric" style="width:95%" value = "<?= $purchase['basefabric'] ?>" class="uphhide basefield" type = "text" id = "basefabric" maxlength = "50"  >
    </div>
</div>
<!-- uphbase start -->
...
<label for="basefabriccost">Price Per Metre:</label><br>
    <input name = "basefabriccost" value = "<?= $purchase['basefabriccost'] ?>" onchange="calculateBaseFabricTotal()" class="xview basefield" type = "number" id = "basefabriccost" size = "15" placeholder="0">
    </div>
    <div class="form-group col-sm-2">
    <label for="basefabricmeters">Fabric Quantity:</label><br> 
    <input name = "basefabricmeters" value = "<?= $purchase['basefabricmeters'] ?>" onchange="calculateBaseFabricTotal()" class="basefield" type = "number" id = "basefabricmeters" size = "15" placeholder="0">
    </div>
    <div class="form-group col-sm-8">
    <label for="basefabricchoice">Fabric Design, Colour & Code:</label><br>
        <input name = "basefabricchoice" style="width:95%" value = "<?= $purchase['basefabricchoice'] ?>" class="basefield" type = "text" id = "basefabricchoice" maxlength = "100">
    </div>
</div>
...
<div class="form-row">
    ...
    <textarea name = "basefabricdesc" id="basefabricdesc" class="fuphhide basefield"  style="width:90%" rows = "1" maxlength="250"><?= $purchase['basefabricdesc'] ?></textarea><span class="pull-right label label-default uphhide" id="basefabriccount"></span>
