...
<div class="form-row">
    ...
    <textarea name = "specialinstructionstopper" id="specialinstructionstopper" class="topperfield"  style="width:90%" rows = "1" maxlength="250"><?= $purchase['specialinstructionstopper'] ?></textarea><span class="pull-right label label-default" id="toppercount"></span>
    </div>
</div>  <!-- row end -->
