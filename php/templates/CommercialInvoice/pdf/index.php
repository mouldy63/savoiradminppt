...
<table class="comminv" cellspacing="0px" cellpadding="3px">
  <tr>
    ...
    <td colspan="2" valign="top">Date: <?= $collectiondate ?><br><br>Invoice No: <br>C.INV-<?= $ordernumber ?></td>
  ...
  <tr>
    ...
    <td colspan="4" valign="top">Country of Origin of Goods: <br><br>United Kingdom</td>
  </tr>
  <tr>
...
border-top: none;"></td>
  ...
  <tr>
    ...
    <td valign="top">Net Weight (kg):<br><?= $totalNW ?></td>
