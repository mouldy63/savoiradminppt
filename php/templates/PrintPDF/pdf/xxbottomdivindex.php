...
<?php if ($accessoriesonly=='') { ?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="3">
  	<tr>
    	...
    	<td width="50%" valign="top" rowspan="2"><span  style="padding: 10px;"><?= $deliverydetails ?></span><br><?= $customersig ?></td>
  	</tr>
  	<tr>
...
if ($accessoriesonly=='y') { 
	echo $accdetails; ?>
	<div class="clear">&nbsp;</div>
	<div style="position: absolute;  bottom: 1px; width: 100%; margin:0; padding:0;">	<table width="101%" border="0" cellspacing="0" cellpadding="3" style="position:relative; left:-3px; padding-right:1px;">
  	<tr>
    	<td width="50%" valign="top"><?= $ordersummary ?></td>
    	<td width="50%" valign="top" rowspan="2"><span  style="padding: 10px;"><?= $deliverydetails ?></span><br><?= $customersig ?></td>
  	</tr>
