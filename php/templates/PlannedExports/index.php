...
<form name="form8" method="post" action="/php/PlannedExports/ordersearch" onSubmit="">
<p>Search for an order number's shipment details: <input type="text" name="orderno" id="orderno" value=""> 

<input type = "submit" name = "submit" value = "Find Shipment" id = "submit" class = "button" /></p>
</form>
