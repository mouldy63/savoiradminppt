...
<div class="form-row">
        <div class="form-group col-sm-6">
            ...
            <input name = "valancefabric" style="width:95%" value = "<?= $purchase['valancefabric'] ?>" class="form-control form-control-sm valancefield" type = "text" id = "valancefabric" maxlength = "50"  >
        </div>
        <div class="form-group col-sm-6">
            <label for="valancefabricchoice">Fabric Design, Colour & Code:</label><br>
            <input name = "valancefabricchoice" style="width:95%" value = "<?= $purchase['valancefabricchoice'] ?>" class="form-control form-control-sm valancefield" type = "text" id = "valancefabricchoice" maxlength = "100"  >
        </div>
    </div>	
...
<div class="form-row">
    ...
    <div class="form-group col-sm-4 xview">
            ...
            <input name = "valfabriccost" style="max-width:90px;" value = "<?= $purchase['valfabriccost'] ?>" class="form-control form-control-sm valancefield" type = "number" class="xview" id = "valfabriccost" size = "15" placeholder="0" onchange="calculateValFabricTotal()">
        </div>
    <div class="form-group col-sm-4">
        <label for="valfabricmeters">Fabric Quantity (meters):</label><br> 
        <input name = "valfabricmeters" style="max-width:90px;" value = "<?= $purchase['valfabricmeters'] ?>" class="form-control form-control-sm valancefield" type = "number" id = "valfabricmeters" size = "15" placeholder="0" onchange="calculateValFabricTotal()">
    </div>
    <div class="form-group col-sm-4 xview">
        <label for="valfabricprice">Fabric Price Total:</label><br>
        <input name = "valfabricprice" style="max-width:90px;" value = "<?= $purchase['valfabricprice'] ?>" class="form-control form-control-sm valancefield" type = "number" class="xview" id = "valfabricprice" size = "15" placeholder="0" onchange="calculateValFabricTotal()">
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-sm-4">
            ...
            <input name = "valancedrop" style="max-width:90px;" value = "<?= $purchase['valancedrop'] ?>" class="form-control form-control-sm valancefield" type = "number" class="xview" id = "valancedrop" size = "15" placeholder="0">
        </div>
    <div class="form-group col-sm-4">
        <label for="valancewidth">Valance Width:</label><br> 
        <input name = "valancewidth" style="max-width:90px;" value = "<?= $purchase['valancewidth'] ?>" class="form-control form-control-sm valancefield" type = "number" id = "valancewidth" size = "15" placeholder="0" >
    </div>
    <div class="form-group col-sm-4">
        <label for="valancelength">Valance Length:</label><br>
        <input name = "valancelength" style="max-width:90px;" value = "<?= $purchase['valancelength'] ?>" class="form-control form-control-sm valancefield" type = "number" class="xview" id = "valancelength" size = "15" placeholder="0" >
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-sm-9">
        ...
        <textarea name = "specialinstructionsvalance" id="specialinstructionsvalance" class="form-control valancefield"  style="width:93%" rows = "1" maxlength="250"><?= $purchase['specialinstructionsvalance'] ?></textarea><span class="pull-right label label-default" id="specialinstructionsvalancecount"></span>
    </div>
