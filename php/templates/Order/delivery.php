...
<div class="form-row">
    ...
    <textarea name = "specialinstructionsdelivery" id="specialinstructionsdelivery" class="form-control deliveryfield"  style="width:90%" rows = "1" maxlength="250"><?= $purchase['specialinstructionsdelivery'] ?></textarea><span class="pull-right label label-default" id="deliverycount"></span>
    </div>
</div>  <!-- row end -->
