...
<thead>
<tr>
	<th class = "tablecell emptycell topcell leftcell"><a href="#" onclick="previousYearOnclick();" id="previousyear" data-start-year="<?php echo $previousYear;?>"><img src="<?php echo str_replace('php/','',Router::url('/', true));?>img/arrow-up.png" alt="previousYear" width="40" height="21"/></a></th>
	<th class = "tablecell emptycell topcell leftcell"></th>
	<th class = "threetwotablecell bordercell nobottomcell">SAVOIR BEDS</th>
</tr>
<tr style="background-color:white;">
	...
	<th class = "twotablecell emptycell bordercell nobottomcell lightgreencell"></th>
</tr>
<tr>
	<th class = "tablecell emptycell leftcell"></th>
	<th class = "tablecell emptycell leftcell"></th>
...
<?php
	...
	foreach($allFigures as $yearKey=>$tempYearFigures){
		...
		$yearShowroomTotal=[3=>0,36=>0,4=>0,27=>0,24=>0,17=>0,25=>0,34=>0,8=>0,33=>0,31=>0,21=>0,28=>0,26=>0];
		$yearShowroomTargetTotal= $yearShowroomTotal;
		$yearShowroomTotalToDate= $yearShowroomTotal;
		$yearShowroomTargetTotalToDate= $yearShowroomTotal;
...
?>
		...
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,3,this);return false;" type="text" value="<?php echo $tempMonthTargets[3]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[3]; ?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,36,this);return false;" type="text" value="<?php echo $tempMonthTargets[36]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[36];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,4,this);return false;" type="text" value="<?php echo $tempMonthTargets[4]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[4];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,27,this);return false;" type="text" value="<?php echo $tempMonthTargets[27]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[27];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,24,this);return false;" type="text" value="<?php echo $tempMonthTargets[24]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[24];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,17,this);return false;" type="text" value="<?php echo $tempMonthTargets[17]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[17];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,25,this);return false;" type="text" value="<?php echo $tempMonthTargets[25]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[25];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,34,this);return false;" type="text" value="<?php echo $tempMonthTargets[34]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[34];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,8,this);return false;" type="text" value="<?php echo $tempMonthTargets[8]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[8];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,33,this);return false;" type="text" value="<?php echo $tempMonthTargets[33]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[33];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,26,this);return false;" type="text" value="<?php echo $tempMonthTargets[26]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[26];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,31,this);return false;" type="text" value="<?php echo $tempMonthTargets[31]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[31];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,21,this);return false;" type="text" value="<?php echo $tempMonthTargets[21]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[21];?></td>
		<td class = "tablecell bordercell"><input class="set_target disablebg" onchange="allTargetsData.changeTarget(
			<?php echo $yearKey;?>,<?php echo $monthKey;?>,28,this);return false;" type="text" value="<?php echo $tempMonthTargets[28]['amount'];?>" disabled/></td>
		<td class = "tablecell bordercell"><?php echo $tempMonthFigures[28];?></td>
...
?>		
	<tr style="background-color:lightblue;">
		...
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[3]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[3]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[36]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[36]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[4]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[4]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[27]*100)/100?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[27]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[24]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[24]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[17]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[17]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[25]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[25]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[34]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[34]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[8]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[8]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[33]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[33]*100)/100 ;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[26]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[26]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[31]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[31]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[21]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[21]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotalToDate[28]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotalToDate[28]*100)/100;?></td>
	...
	<tr style="background-color:lightblue;">
		...
		<td class = "tablecell leftcell topbottomcell"></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[3]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[3]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[36]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[36]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[4]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[4]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[27]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[27]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[24]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[24]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[17]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[17]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[25]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[25]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[34]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[34]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[8]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[8]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[33]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[33]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[26]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[26]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[31]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[31]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[21]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[21]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTargetTotal[28]*100)/100;?></td>
		<td class = "tablecell bordercell"><?php echo round($yearShowroomTotal[28]*100)/100;?></td>
		<td class = "tablecell emptycell bordercell"></td>
		<td class = "tablecell emptycell bordercell"></td>
		<td class = "tablecell emptycell bordercell"></td>
		<td class = "tablecell emptycell bordercell"></td>
...
function worldTableGenerator(allFigures,allTargets){
	...
	for(yearKey in allFigures){
		...
		var yearShowroomTotal={3:0,36:0,4:0,27:0,24:0,17:0,25:0,34:0,8:0,33:0,31:0,21:0,28:0,26:0};
		var yearShowroomTargetTotal={3:0,36:0,4:0,27:0,24:0,17:0,25:0,34:0,8:0,33:0,31:0,21:0,28:0,26:0};
		var yearShowroomTotalToDate={3:0,36:0,4:0,27:0,24:0,17:0,25:0,34:0,8:0,33:0,31:0,21:0,28:0,26:0};
		var yearShowroomTargetTotalToDate={3:0,36:0,4:0,27:0,24:0,17:0,25:0,34:0,8:0,33:0,31:0,21:0,28:0,26:0};
		for(monthKey in tempYearFigures){
			...
			'type="text" value="'+ tempMonthTargets[26]['amount'] +'" disabled/></td>';
			str += '<td class = "tablecell bordercell">' + tempMonthFigures[26] + '</td>';
			str += '<td class = "tablecell bordercell">' +
		...
		str += '<td class = "tablecell leftcell topbottomcell"></td>';
			...
			str += '<td class = "tablecell bordercell">' + Math.round(yearShowroomTargetTotalToDate[26]*100)/100 + '</td>';
			str += '<td class = "tablecell bordercell">' + Math.round(yearShowroomTotalToDate[26]*100)/100 + '</td>';
		...
		str += '<td class = "tablecell leftcell topbottomcell"></td>';
			...
			str += '<td class = "tablecell bordercell">' + Math.round(yearShowroomTargetTotal[26]*100)/100 + '</td>';
			str += '<td class = "tablecell bordercell">' + Math.round(yearShowroomTotal[26]*100)/100 + '</td>';
