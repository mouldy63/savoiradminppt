...
<head>
	...
	<?php
		...
		echo $this->Html->css(['//cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css']);
		echo $this->Html->css(['//cdn.datatables.net/scroller/2.3.0/css/scroller.dataTables.min.css']);
		echo $this->Html->css(['//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css']);
		echo $this->Html->css(['screen']);
		echo $this->fetch('css');
		echo $this->Html->script('//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/js/all.min.js');
		echo $this->Html->script('//code.jquery.com/jquery-3.7.0.js');
		echo $this->Html->script('//code.jquery.com/ui/1.11.2/jquery-ui.js');
		echo $this->Html->script('//cdn.datatables.net/1.13.7/js/jquery.dataTables.min.js');
		echo $this->Html->script('//cdn.datatables.net/scroller/2.3.0/js/dataTables.scroller.min.js');
