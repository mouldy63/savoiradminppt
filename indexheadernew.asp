...
%>
<div> <a href="index.asp"><img src="/images/logo-s.gif" border="0" /></a>
  <p align="right">&nbsp;Lead Time: London = <%=londonNo%> weeks, Cardiff = <%=cardiffNo%> weeks | Logged in as <%=retrieveUserName()%> | <a href="/access/logout.asp"> Logout</a></p>
</div>
<div id="adminhdr">
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <%end if%>
      <a href="/customerservicelist.asp">Outstanding Case</a>
    </div>
  </li>
  <%end if%>
...
<div id="adminhdr2">
<form action="search-results.asp" method="post" name="form1" onSubmit="return FrontPageForm1_Validator(this)">
	
				  <label for="surname" id="surname" ><strong>Surname:</strong>
				    <input name="surname" type="text" class="text" id="surname" size="22" />
			      </label><label for="cref" id="cref"><strong>&nbsp;&nbsp;Customer Ref:</strong>
				    <input name="cref" type="text" class="text" id="cref" size="22" />
			      </label><label for="company" id="cref"><strong>&nbsp;&nbsp;Company:</strong>
				    <input name="company" type="text" class="text" id="company" size="22" />
			      </label> <label for="orderno" id="orderno"><strong>&nbsp;&nbsp;Order No:</strong>
				    <input name="orderno" type="text" class="text" id="orderno" size="10" />
			      </label> <input name="channel" type="hidden" value="n"> <input name="qresults" type="hidden" value="y">
