...
sql="SELECT * FROM contact C, Address A, Location L WHERE C.code=A.code and C.idlocation = L.idlocation and C.is_developer='n' AND C.contact_no<>319256 AND C.contact_no<>24188 and C.contact_no >332397 and C.CONTACT_NO<353196 and (C.owning_region=4 OR C.OWNING_REGION=12 or C.OWNING_REGION=13 or C.OWNING_REGION=14 or C.idlocation=49)                                                                                                                                                   "
'response.End()
