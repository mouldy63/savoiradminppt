...
<div class="container">
<!-- #include file="indexheadernew.asp" -->
...
sql = "Select * from address A, contact C, Purchase P Where C.retire='n' AND A.code=C.code AND C.code=P.code AND P.orderonhold='y'"
